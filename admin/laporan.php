...
<div id='judul_kontent'><p align="center" class="style2">DAFTAR NAMA LULUS SERTIFIKASI</p>
</div>
...
<?php
$sql = mysql_query("select * from acount where keterangan LIKE '%lulus%'");
$no=1;
...
<br><br>
<a href="cetak_lulus.php" class="style1">Cetak Laporan</a><br>
<br>
<?
