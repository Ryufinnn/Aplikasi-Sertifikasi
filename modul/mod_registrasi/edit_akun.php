...
<tr><td> NIS</td><td><input type='text' name='nm_depan' value='<?echo $_SESSION[namadepan];?>' ></td></tr> 
<tr><td> Nama Siswa</td><td><input type='text' name='nm_belakang' value='<?echo $_SESSION[namabelakang];?>' ></td></tr> 
<tr><td> Username</td><td><input type='text' value='<?echo $r[email];?>' name='email'></td></tr> 
...
<input name="jk" type="radio" value="Perempuan"/>Perempuan</td>
<?
}else{
?>
<td>
<input name="jk" type="radio"  value="Laki-Laki"/>Laki-Laki
<input name="jk" type="radio" checked value="Perempuan"/>Perempuan</td>
<?
}
?></tr>	
<?
...
<tr><td> Tanggal Lahir </td><td>
				   ...
				   <tr><td> No Hp</td><td><input type='text' value='<?echo $r[nohp];?>' name='nohp'></td></tr> 
				   <tr><td> Alamat</td><td><input type='text' value='<?echo $r[alamat];?>' name='alamat'></td></tr> 
				   <tr><td> Nama Ayah</td><td><input type='text' value='<?echo $r[nama_a];?>' name='nama_a'></td></tr> 
				   <tr><td> Pekerjaan Ayah</td><td><input type='text' value='<?echo $r[pekerjaan_a];?>' name='pekerjaan_a'></td></tr> 
				  
				   <tr><td> Nama Ibu</td><td><input type='text' value='<?echo $r[nama_i];?>' name='nama_i'></td></tr> 
				   <tr><td> Pekerjaan Ibu</td><td><input type='text' value='<?echo $r[pekerjaan_i];?>' name='pekerjaan_i'></td></tr> 
